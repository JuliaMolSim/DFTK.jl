...
# See discussion in
# https://github.com/JuliaMolSim/DFTK.jl/issues/1111
...
tol = 1e-8
scfres = self_consistent_field(basis; tol, diagtolalg=AdaptiveDiagtol(; diagtol_max=tol),
...
phret_q0 = @time DFTK.phonon_modes(scfres; q=[0.0, 0.0, 0.0]);
nothing  # hide
