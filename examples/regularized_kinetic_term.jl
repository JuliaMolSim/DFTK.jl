...
include("/home/lvidal/Documents/CERMICS/these/modified_kinetic_term/g_function.jl")

function compute_energies_Si(g)
    ...
    model = Model(lattice; atoms=atoms, terms=[RegularizedKinetic(g=g), AtomicLocal()])
