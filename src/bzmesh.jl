...
function build_kgrid(lattice::AbstractMatrix, kgrid::Union{AbstractVector,Tuple})
    build_kgrid(lattice, MonkhorstPack(kgrid; kshift=[1, 1, 1]))
end
...
"""
function KgridMaximalSpacing(spacing; kshift=[1, 1, 1])
...
function KgridMinimalNumber(n_kpoints; kshift=[1, 1, 1])
