...
"""
    ...
    Parameters can be added as kwargs : e.g. num_iter = 500.
"""
...
"""
function Ak_matrix_gaussian_guesses(basis::PlaneWaveBasis, ψ, k::Integer,
    ...
    G_vec = (2π) .*[G for (iG,G) in enumerate(G_vectors(basis))] # 2π .* -> reduced coords
...
function generate_amn_file(prefix::String,basis::PlaneWaveBasis,ψ, n_wann::Integer;
    ...
    open("$prefix.amn", "w") do f
        ...
        # Matrices
        for k in 1:k_size
            Ak = compute_Ak(basis,ψ,k,n_bands,n_wann;
...
# """
#     Test to wrap everything in a single routine
# """
