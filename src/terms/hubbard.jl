...
struct Hubbard{T}
    ...
    function Hubbard{T}(manifolds::Vector{OrbitalManifold}, U::Vector{T}) where {T}
        ...
        U = austrip.(U)
        new{eltype(U)}(manifolds, U)
    end
end
# Match the outer ctor generated by Julia if we had not defined our own inner ctor.
# See https://docs.julialang.org/en/v1.12/manual/constructors/#Parametric-Constructors
function Hubbard(manifolds::Vector{OrbitalManifold}, U::Vector{T}) where {T}
    Hubbard{T}(manifolds, U)
end
