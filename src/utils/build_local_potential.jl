"""
    build_local_potential(pw::PlaneWaveBasis, generators_or_species...;
...
The contributions are defined by the `generators_or_species` pairs. In the simplest case
...
```
"""
function build_local_potential(pw::PlaneWaveBasis, generators_or_species...;
                               compensating_background=true)
    ...
    genfunctions = [make_generator(elem) => positions
                    for (elem, positions) in generators_or_species]
