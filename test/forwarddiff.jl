...
@testitem "Symmetries broken by perturbation are filtered out" tags=[:dont_test_mpi] begin
    ...
    @testset "Atom movement" begin
        ...
        symmetries_filtered = DFTK.remove_broken_symmetries(lattice, atoms, positions_modified, symmetries_full)
    ...
    @testset "Lattice strain" begin
        ...
        symmetries_filtered = DFTK.remove_broken_symmetries(lattice_modified, atoms, positions, symmetries_full)
    ...
    @testset "Atom movement + lattice strain" begin
        ...
        positions_modified = [[0., 0., 0.], [0.5 + ε, 0., 0.]]
        lattice_modified = diagm([2., 1., 1. + ε])
        symmetries_filtered = DFTK.remove_broken_symmetries(lattice_modified, atoms, positions_modified, symmetries_full)
